...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/@sentry/nuxt/build/module/runtime/plugins/route-detector.server.js")> &
  InjectionType<typeof import("../../node_modules/nuxt/dist/app/plugins/warn.dev.server.js")> &
  InjectionType<typeof import("../../node_modules/nuxt/dist/app/plugins/check-if-layout-used.js")> &
  InjectionType<typeof import("../../app/plugins/01.axios")> &
  InjectionType<typeof import("../../app/plugins/02.fontawesome")> &
  InjectionType<typeof import("../../app/plugins/03.auth-init.client")> &
  InjectionType<typeof import("../../app/plugins/04.prefs.client")> &
  InjectionType<typeof import("../../app/plugins/05.klaro.client")> &
  InjectionType<typeof import("../../app/plugins/gsap.client")> &
  InjectionType<typeof import("../../node_modules/@sentry/nuxt/build/module/runtime/plugins/sentry.client.js")>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'vue-devtools-client' | 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:head' | 'nuxt:router' | 'nuxt:browser-devtools-timing' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload-crawler' | 'nuxt:chunk-reload' | 'nuxt:island-link-navigation' | 'pinia' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'sentry-client-config' | 'nuxt:checkIfLayoutUsed' | 'sentry-client-integrations'
  }
}

declare global {
  ...
  const fetchPublicContentEntries: typeof import('../../server/utils/sitemap-content').fetchPublicContentEntries
  ...
  const wrapMiddlewareHandlerWithSentry: typeof import('../../node_modules/@sentry/nuxt/build/module/runtime/hooks/wrapMiddlewareHandler').wrapMiddlewareHandlerWithSentry
...
declare global {
  ...
  // @ts-ignore
  export type { SitemapUrlEntry } from '../../server/utils/sitemap-content'
  import('../../server/utils/sitemap-content')
}
...
export { useAppConfig } from '/app/node_modules/@nuxt/nitro-server/dist/runtime/utils/app-config';
export { wrapMiddlewareHandlerWithSentry } from '/app/node_modules/@sentry/nuxt/build/module/runtime/hooks/wrapMiddlewareHandler';
export { fetchPublicContentEntries } from '/app/server/utils/sitemap-content';
...
const createItems = computed(() => [
  ...
  {
    label: 'StatsData',
    description: 'Assemblez blocs, graphiques et tableaux dans le studio.',
    to: '/studio/statsdata/nouveau',
    icon: 'stats' as const,
    action: 'Créer',
    comingSoon: false,
  },
  {
    label: 'Sondage',
    description: 'Consultez les sondages ouverts et préparez les prochains formats.',
    to: '/sondages',
    icon: 'polls' as const,
    action: 'Ouvrir',
    comingSoon: false,

...
<template>
  <!--
    ...
    so this section's background bleeds all the way under the fixed header. The real content
    offset comes back from pt-44 lg:pt-40 below. Keep both files' breakpoint pairs in sync.
  -->
  <section class="relative -mt-40 overflow-hidden bg-white lg:-mt-28">
    <div

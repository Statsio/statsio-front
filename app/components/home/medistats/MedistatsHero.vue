...
import { homeContent } from '@/data/brands/medistats/home'
...
<template>
  <section ref="heroRef" class="relative -mt-28 overflow-hidden bg-white">
    ...
    <div
      ...
      style="background-image: radial-gradient(circle, rgba(153,27,27,0.08) 1px, transparent 1px); background-size: 28px 28px;"
      aria-hidden="true"
    />
      ...
      <div class="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        ...
        <div class="space-y-6">
          ...
          <div data-anim="ctas" class="flex flex-wrap items-center gap-3">
            <AppButton as="router-link" to="/medistats/maladies" variant="primary" size="lg">
        ...
        <!-- Right: health indicator chart preview -->
        <div data-anim="card" class="card-xl p-6">
          <div class="mb-4 flex items-center justify-between">
            ...
            <span class="mono text-[11px] font-semibold text-emerald-600">▼ 5.1%</span>
          </div>

...
<template>
  <div class="space-y-4 py-2">
    <p class="text-sm text-slate-500">
      Sélectionnez une ou plusieurs catégories pour aider les lecteurs à trouver votre contenu.
    </p>
    ...
    <div v-else class="flex flex-wrap gap-2.5">
      <button
        ...
        :class="modelValue.includes(cat.slug)
      ...
      >
        <svg
          v-if="modelValue.includes(cat.slug)"
    ...
    <p v-if="modelValue.length > 0" class="text-xs text-[var(--color-primary)] font-medium">

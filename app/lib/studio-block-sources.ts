...
function requalifyMapping(fm: FieldMapping, colToSource: Map<string, string>): FieldMapping {
  ...
  return {
    ...
    latColumn: r(fm.latColumn),
    lngColumn: r(fm.lngColumn),
    mapPointColumn: r(fm.mapPointColumn),
    mapTitleColumn: r(fm.mapTitleColumn),
    mapColorColumn: r(fm.mapColorColumn),
    mapSizeColumn: r(fm.mapSizeColumn),
